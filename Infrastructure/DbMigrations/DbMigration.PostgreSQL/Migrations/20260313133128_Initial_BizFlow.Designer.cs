...
namespace DbMigration.PostgreSQL.Migrations
{
    ...
    [Migration("20260313133128_Initial_BizFlow")]
    partial class Initial_BizFlow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.CreditPayment", b =>
                {
                    ...
                    b.Property<Guid>("CustomerCreditId1")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.CreditPayment", b =>
                {
                    b.HasOne("Domain.Entities.CustomerCredit", null)
                        .WithMany("Payments")
                    ...
                    b.HasOne("Domain.Entities.CustomerCredit", "CustomerCredit")
                        .WithMany()
                        .HasForeignKey("CustomerCreditId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

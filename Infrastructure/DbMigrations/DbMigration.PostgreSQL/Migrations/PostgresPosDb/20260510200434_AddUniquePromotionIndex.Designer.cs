...
namespace DbMigration.PostgreSQL.Migrations.PostgresPosDb
{
    ...
    [Migration("20260510200434_AddUniquePromotionIndex")]
    partial class AddUniquePromotionIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Promotion", b =>
                {
                    ...
                    b.HasIndex("MainProductId", "IsDeleted")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");
            ...
            modelBuilder.Entity("Domain.Entities.PromotionTier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PromotionTiers", (string)null);
                });
